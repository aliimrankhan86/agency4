    ...
    >
      ...
      <div className="mx-auto max-w-7xl w-full px-6 pt-56 pb-24 z-10 lg:pt-80">
        <div className="flex flex-col items-center max-w-4xl mx-auto">
          <h1 className="animate mt-4 px-2 font-onest text-white font-medium text-5xl text-center leading-[1.2] md:text-8xl">
            Smarter Voice. Real Automation.
          </h1>
          <p className="animate mt-6 px-2 font-figtree text-lg text-white text-center max-w-3xl">
        ...
        <div className="mt-32 flex flex-col items-center justify-between gap-12 lg:flex-row lg:mt-48">
          <ul className="grid grid-cols-2 gap-y-6 lg:grid-flow-col-dense" role="list" aria-label="Key performance metrics">
            <li className="animate text-center border-r px-6 border-white/12 lg:text-left lg:px-8">
            ...
            <li className="animate text-center px-6 lg:text-left lg:px-8">
              <div className="font-onest text-2xl font-medium text-white">
                24/7 Availability
              </div>
            ...
            <li className="animate col-span-2 text-center border-t pt-6 border-white/12 lg:border-l lg:border-t-0 lg:pt-0 lg:pl-8 lg:text-left">
              <div className="font-onest text-2xl font-medium text-white">
                3x Faster Response
              </div>
              <div className="mt-2 font-figtree text-sm text-white">
          ...
          <p className="animate font-figtree text-center text-base text-white max-w-sm lg:text-left">
